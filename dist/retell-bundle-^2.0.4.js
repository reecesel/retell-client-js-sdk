(() => {
    ...
    return {
      ...
      writeMessage(message, options) {
        ...
        try {
          ...
          const r3 = e instanceof Error ? e.message : String(e);
  ...
  function r2(t, e) {
    return r2 = Object.setPrototypeOf ? Object.setPrototypeOf.bind() : function(t2, e2) {
  ...
  var s = /* @__PURE__ */ function(t) {
    ...
    function u() {
      var e;
      return (e = t.call(this) || this).room = void 0, e.connected = false, e.isAgentTalking = false, e.analyzerComponent = void 0, e.captureAudioFrame = void 0, e;
    }
    l = t, (s2 = u).prototype = Object.create(l.prototype), s2.prototype.constructor = s2, r2(s2, l);
    var d = u.prototype;
    return d.startCall = function(t2) {
      try {
        var n = this, o = function(o2, a) {
          try {
            var i = (n.room = new Room({ audioCaptureDefaults: { autoGainControl: true, echoCancellation: true, noiseSuppression: true, channelCount: 1, deviceId: t2.captureDeviceId, sampleRate: t2.sampleRate }, audioOutput: { deviceId: t2.playbackDeviceId } }), n.handleRoomEvents(), n.handleAudioEvents(t2), n.handleDataEvents(), Promise.resolve(n.room.connect("wss://retell-ai-4ihahnq7.livekit.cloud", t2.accessToken)).then(function() {
      ...
      if (this.connected && this.analyzerComponent) {
        var e = new Float32Array(this.analyzerComponent.analyser.fftSize);
        this.analyzerComponent.analyser.getFloatTimeDomainData(e), this.emit("audio", e), this.captureAudioFrame = window.requestAnimationFrame(function() {
          return t2.captureAudioSamples();
        });
      }
    }, d.handleRoomEvents = function() {
      var t2 = this;
      this.room.on(RoomEvent.ParticipantDisconnected, function(e) {
        "server" === (null == e ? void 0 : e.identity) && t2.stopCall();
      ...
      this.room.on(RoomEvent.TrackSubscribed, function(n, r3, c2) {
        n.kind === Track.Kind.Audio && ("agent_audio" === r3.trackName && n instanceof RemoteAudioTrack && t2.emitRawAudioSamples && (e.analyzerComponent = createAudioAnalyser(n), e.captureAudioFrame = window.requestAnimationFrame(function() {
          return e.captureAudioSamples();
        })), n.attach());
      });
    }, d.handleDataEvents = function() {
      var t2 = this;
      this.room.on(RoomEvent.DataReceived, function(e, n, o, a) {
        try {
          if ("server" !== (null == n ? void 0 : n.identity)) return;
          var i = c.decode(e), r3 = JSON.parse(i);
          "update" === r3.event_type ? t2.emit("update", r3) : "metadata" === r3.event_type ? t2.emit("metadata", r3) : "agent_start_talking" === r3.event_type ? (t2.isAgentTalking = true, t2.emit("agent_start_talking")) : "agent_stop_talking" === r3.event_type && (t2.isAgentTalking = false, t2.emit("agent_stop_talking"));
        } catch (t3) {
