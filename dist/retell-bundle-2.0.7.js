  ...
  var s = /* @__PURE__ */ function(t) {
    ...
    return d.startCall = function(t2) {
      ...
      this.room.on(RoomEvent.ParticipantDisconnected, function(e) {
        "server" === (null == e ? void 0 : e.identity) && setTimeout(function() {
          t2.stopCall();
        }, 500);
      ...
      this.room.on(RoomEvent.TrackSubscribed, function(n, r3, c2) {
        n.kind === Track.Kind.Audio && n instanceof RemoteAudioTrack && ("agent_audio" === r3.trackName && (e.emit("call_ready"), t2.emitRawAudioSamples && (e.analyzerComponent = createAudioAnalyser(n), e.captureAudioFrame = window.requestAnimationFrame(function() {
          return e.captureAudioSamples();
        }))), n.attach());
      });
    }, d.handleDataEvents = function() {
      var t2 = this;
      this.room.on(RoomEvent.DataReceived, function(e, n, o, i) {
        try {
          if ("server" !== (null == n ? void 0 : n.identity)) return;
          var a = c.decode(e), r3 = JSON.parse(a);
